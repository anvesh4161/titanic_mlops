...
class DataProcessing:
    ...
    def handle_imbalance_data(self):
        try:
            ...
            logger.info("Imbalance data handled using SMOTE successfully.")

        except Exception as e:
            logger.error(f"Error while handling imbalance data: {e}")
            raise CustomException(str(e), sys)
    ...
    def store_feature_in_redis(self):
        try:
            ...
            self.feature_store.batch_insert(batch_data)
...
if __name__ == "__main__":
    ...
    print(data_processor.retrieve_feature_redis_Store(entity_id=332))
